...
public class CRConfig {
  ...
  static public CRConfig initialize(final String[] args) {
    ...
    {
      final Option input = new Option("input", "input", true, "input directory");
    ...
    {
      final Option output = new Option("output", "output", true, "output directory");
    ...
    {
      final Option language = new Option("lang", "language", true, "language");
    ...
    {
      final Option encoding = new Option("encoding", "encoding", true, "encoding");
    ...
    {
      final Option blankline = new Option("blankline", "blankline", false, "blankline");
    ...
    {
      final Option blockcomment =
          new Option("blockcomment", "blockcomment", false, "block comment");
    ...
    {
      final Option linecomment = new Option("linecomment", "linecomment", false, "line comment");
    ...
    {
      final Option bracketline = new Option("bracketline", "bracketline", false, "bracket line");
    ...
    {
      final Option indent = new Option("indent", "indent", false, "indent");
    ...
    {
      final Option verbose = new Option("v", "verbose", false, "verbose output");
  ...
  public OPERATION getBLANKLINE() {
    return this.commandLine.hasOption("blankline")
        ? OPERATION.getOPERATION(this.commandLine.getOptionValue("blankline"))
        : OPERATION.RETAIN;
  }

  public OPERATION getBLOCKCOMMENT() {
    return this.commandLine.hasOption("blockcomment")
        ? OPERATION.getOPERATION(this.commandLine.getOptionValue("blockcomment"))
        : OPERATION.REMOVE;
  }

  public OPERATION getLINECOMMENT() {
    return this.commandLine.hasOption("linecomment")
        ? OPERATION.getOPERATION(this.commandLine.getOptionValue("linecomment"))
        : OPERATION.REMOVE;
  }

  public OPERATION getBRACKETLINE() {
    return this.commandLine.hasOption("bracketline")
        ? OPERATION.getOPERATION(this.commandLine.getOptionValue("bracketline"))
        : OPERATION.RETAIN;
  }

  public OPERATION getINDENT() {
    return this.commandLine.hasOption("indent")
        ? OPERATION.getOPERATION(this.commandLine.getOptionValue("indent"))
        : OPERATION.RETAIN;
  }
