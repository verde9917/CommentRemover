...
abstract public class CommentRemover {
  ...
  public static void main(final String[] args) {
    ...
    if (inputFile.isFile()) {
      ...
      } else if (LANGUAGE.PHP.isTargetFile(input)) {
      ...
      if (null != remover) {
        final String text =
            FileUtility.readFile(inputFile, config.hasENCODING() ? config.getENCODING() : null);
      ...
      final SortedSet<File> files = FileUtility.getFiles(inputFile, language);
